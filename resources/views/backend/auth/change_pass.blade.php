...
@section('title')
    Đổi mật khẩu - @lang('app.app_title')
@endsection
@section('main')
    <div class="content">
                                    ...
                                    <div class="">
                                        <form class="form-horizontal" action="{{route('admin.changePass')}}" method="POST">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-2 col-form-label" for="email">Địa chỉ Email</label>
                                                <div class="col-lg-10">
                                                    <input type="email" disabled="" class="form-control" required="" name="email" id="email" placeholder="Nhập địa chỉ email" value="{{$user->email}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-2 col-form-label" for="re-password">Xác nhận</label>
                                                <div class="col-lg-10">
                                                    <input class="form-control" type="password" required="" id="re-password" name="re-password" placeholder="Xác nhận mật khẩu mới">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group text-center mb-0">
                                                ...
                                                <a href="{{route('dashboard')}}" class="btn btn-secondary waves-effect waves-light">Hủy</a>
                                            </div>
