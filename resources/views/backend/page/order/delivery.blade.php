...
@section('title')
    @lang('title.order.delivery') - @lang('app.app_title')
@endsection
@section('main')
    <div class="content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="page-title">@lang('title.order.delivery')</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb p-0 m-0">
                                <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Trang chủ</a></li>
                                <li class="breadcrumb-item active">@lang('title.order.delivery')</li>
                            </ol>
                        </div>
                            ...
                            <table id="datatable" class="table table-striped table-bordered "
                                ...
                                @foreach($order as $ct)
                                    <tr class="text-center">
                                        ...
                                        @if($ct['status'] == 2)
                                            <td class="text-danger"><i class="ion ion-ios-alert text-danger"></i> Đang giao hàng
                                            </td>
                                        @endif
                                    </tr>
                                @endforeach
