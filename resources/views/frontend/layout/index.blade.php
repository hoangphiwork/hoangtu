		...
		<div class="container">
			<div class="row">
				<div id="logo" class="col-md-3 col-sm-12 col-xs-12">
					<h1>
						<a href="{{route('home')}}"><img width="70%" src="assets\images\logo_light_ui.png"></a>
				...
				<div id="search" class="col-md-7 col-sm-12 col-xs-12">
					<form action="{{route('search')}}" method="get">
						@csrf
						<input type="text" id="search-box" name="search" style="border-radius: 8px; margin-right: 8px;" placeholder="Nhập từ khóa tìm kiếm">
						<input type="submit" name="submit" style="border-radius: 8px; font-size: 15px; color: #000;" value="Tìm Kiếm">
					</form>
				</div>
				<div id="cart" class="col-md-2 col-sm-12 col-xs-12">
					<a href="{{route('cart.index')}}">{{ Cart::getContent()->count()}}</a>
				</div>
			</div>
		</div>
	</header><!-- /header -->
			...
			<div class="row">
				<div id="sidebar" class="col-md-3">
					<nav id="menu">
						<ul>
							...
							@foreach($cate as $ct)
								@if($ct['status'] == 1)
								<li class="menu-item">
									<a href="{{route('category.show', ['slug' => $ct['slug']])}}" title="">{{$ct['name']}}</a>
								</li>
								@endif
							@endforeach
						</ul>
					...
					<div id="banner-l" class="text-center">
                            ...
                            <div class="banner-l-item">
                                <img src="upload/banner/3.png" alt="" class="img-thumbnail">
                            </div>
                            <div class="banner-l-item">
                                <img src="upload/banner/4.png" alt="" class="img-thumbnail">
                            </div>
                            <div class="banner-l-item">
                                <img src="upload/banner/5.png" alt="" class="img-thumbnail">
                            </div>
					</div>
				</div>
			...
			<div class="container">
				<div class="row" style="margin-bottom: 15px;">
					<div id="about" class="col-md-4 col-sm-12 col-xs-12">
						...
						<div>
							<a href="{{route('home')}}" class="non-textdecoration">
								<span class="text-white">Trang chủ</span>
							</a>
						</div>
						<div>
							<a href="javascript:void()" class="non-textdecoration">
				...
				<div class="container">
					<div class="row">
						...
						<div id="footer-b-r" class="col-md-6 col-sm-12 col-xs-12 text-center">
							<p>© 2020 <a href="{{route('home')}}" class="non-textdecoration"><span class="text-white font-weight-bold">Hoàng Tú</span></a>. All Rights Reserved</p>
						</div>
					</div>
				</div>
				<div id="scroll">
					<a href="{{route('home')}}"><img src="customer/img/home/scroll.png"></a>
				</div>
			</div>
		</div>
	</footer>
