...
<div id="wrap-inner">
	...
	<div id="pagination" class="pagination justify-content-center pagination-lg" style="margin-top: 30px;">
		{{$products->links()}}
	</div>
</div>
@endsection
@section('title')
<title>Tất cả sản phẩm - Hoàng Tú | Phụ kiện máy tính, đổ mực máy in ...</title>
@endsection
